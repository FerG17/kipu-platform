...
namespace Bodega.Platform.Shared.Infrastructure.Persistence.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20260816165655_AddProductSupplier")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bodega.Platform.Alerts.Domain.Model.Aggregates.Alert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Alerts.Domain.Model.Entities.AlertRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Dashboard.Domain.Model.Entities.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Iam.Domain.Model.Aggregates.Business", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Iam.Domain.Model.Aggregates.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Iam.Domain.Model.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Products.Domain.Model.Aggregates.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Products.Domain.Model.Aggregates.Warehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Products.Domain.Model.Entities.Batch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Products.Domain.Model.Entities.InventoryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Products.Domain.Model.Entities.ProductSupplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Products.Domain.Model.Entities.StockMovement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Sales.Domain.Model.Aggregates.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Sales.Domain.Model.Aggregates.Sale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Sales.Domain.Model.Entities.PaymentPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Sales.Domain.Model.Entities.SaleDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Suppliers.Domain.Model.Aggregates.PurchaseOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Suppliers.Domain.Model.Aggregates.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Suppliers.Domain.Model.Entities.PurchaseOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bodega.Platform.Alerts.Domain.Model.Aggregates.Alert", b =>
                {
                    b.HasOne("Bodega.Platform.Products.Domain.Model.Entities.Batch", null)
                        .WithMany()
                        .HasForeignKey("BatchId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_alerts_batch_batch_id");

                    b.HasOne("Bodega.Platform.Iam.Domain.Model.Aggregates.Business", null)
                        .WithMany()
                    ...
                    b.HasOne("Bodega.Platform.Products.Domain.Model.Aggregates.Product", null)
                        .WithMany()
                    ...
                    b.HasOne("Bodega.Platform.Products.Domain.Model.Aggregates.Warehouse", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Bodega.Platform.Iam.Domain.Model.Aggregates.User", b =>
                {
                    ...
                    b.HasOne("Bodega.Platform.Iam.Domain.Model.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Bodega.Platform.Sales.Domain.Model.Aggregates.Sale", b =>
                {
                    ...
                    b.HasOne("Bodega.Platform.Sales.Domain.Model.Aggregates.Customer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Bodega.Platform.Sales.Domain.Model.Entities.PaymentPlan", b =>
                {
                    ...
                    b.HasOne("Bodega.Platform.Sales.Domain.Model.Aggregates.Sale", null)
                        .WithOne()
                        .HasForeignKey("Bodega.Platform.Sales.Domain.Model.Entities.PaymentPlan", "SaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Bodega.Platform.Suppliers.Domain.Model.Aggregates.PurchaseOrder", b =>
                {
                    ...
                    b.HasOne("Bodega.Platform.Suppliers.Domain.Model.Aggregates.Supplier", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Bodega.Platform.Suppliers.Domain.Model.Entities.PurchaseOrderDetail", b =>
                {
                    ...
                    b.HasOne("Bodega.Platform.Suppliers.Domain.Model.Aggregates.PurchaseOrder", null)
                        .WithMany("Details")
