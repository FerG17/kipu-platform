...
public class TimeZoneBehaviourTests(KipuApiFactory factory) : IntegrationTestBase(factory)
{
    ...
    private sealed class FrozenClockApiFactory(DateTimeOffset frozenAt) : KipuApiFactory
    {
