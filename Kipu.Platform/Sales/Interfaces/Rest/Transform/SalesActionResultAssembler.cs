...
public static class SalesActionResultAssembler
{
    ...
    private static int MapErrorToStatusCode(SalesError error)
    {
        return error switch
        {
            ...
            SalesError.InstallmentAmountMismatch => StatusCodes.Status400BadRequest,
            SalesError.InstallmentNotFound => StatusCodes.Status404NotFound,
            SalesError.InstallmentAlreadyPaid => StatusCodes.Status409Conflict,
